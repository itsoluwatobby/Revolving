...
messageRouter.delete('/conversation/:conversationId', verifyRoles([ROLES.USER]), (req: Request, res: Response) => messageController.deleteConversation(req, res));
...
messageRouter.get('/single_conversation/:conversationId', verifyRoles([ROLES.USER]), (req: Request, res: Response) => messageController.getConversation(req, res));
