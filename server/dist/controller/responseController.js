...
class ResponseController {
    createNewResponse(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            const comment = yield responseServiceInstance.getCommentById(commentId);
            if (!comment)
                return responseType({ res, status: 404, message: 'Comment not found' });
            // if(user?.isAccountLocked) return responseType({res, status: 423, message: 'Account locked'});
            responseServiceInstance.createResponse(Object.assign({}, newResponse))
    ...
    updateResponse(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            // if(user?.isAccountLocked) return responseType({res, status: 423, message: 'Account locked'});
            const responseExist = yield responseServiceInstance.getResponseById(responseId);
            if (!responseExist)
    ...
    deleteResponse(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user)
                return responseType({ res, status: 401, message: 'You do not have an account' });
            // if(user?.isAccountLocked) return responseType({res, status: 423, message: 'Account locked'});
            const response = yield responseServiceInstance.getResponseById(responseId);
        ...
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (adminUser === null || adminUser === void 0 ? void 0 : adminUser.roles.includes(ROLES.ADMIN)) {
                if ((option === null || option === void 0 ? void 0 : option.command) == 'onlyInComment') {
                    responseServiceInstance.deleteAllUserResponseInComment(userId, option === null || option === void 0 ? void 0 : option.commentId)
    ...
    userResponses(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            getCachedResponse({ key: `userResponses:${userId}/${responseId}`, cb: () => __awaiter(this, void 0, void 0, function* () {
                    const userResponse = yield responseServiceInstance.getUserResponses(userId, responseId);
                    return userResponse;
                }), reqMtd: ['POST', 'PUT', 'PATCH', 'DELETE'] })
                .then((userResponses) => {
    ...
    getResponseByComment(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            getCachedResponse({ key: `responseInComment:${commentId}`, cb: () => __awaiter(this, void 0, void 0, function* () {
                    const responses = yield responseServiceInstance.getAllCommentsResponse(commentId);
                    return responses;
                }), reqMtd: ['POST', 'PUT', 'PATCH', 'DELETE'] })
