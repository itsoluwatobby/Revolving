...
class TaskManger {
    ...
    deleteUserTask(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user)
                return responseType({ res, status: 403, message: 'You do not have an account' });
            const task = yield TaskManagerServiceInstance.getTaskById(taskId);
            if (!task)
    ...
    emptyBin(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!user)
                return responseType({ res, status: 403, message: 'You do not have an account' });
            const task = yield TaskManagerServiceInstance.getTaskInBin(userId);
            if (!task)
    ...
    getUserTask(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            getCachedResponse({ key: `tasks:${userId}`, timeTaken: 1800, cb: () => __awaiter(this, void 0, void 0, function* () {
                    const tasks = yield TaskManagerServiceInstance.getUserTasks(userId);
                    return tasks;
