...
class SharedStoryController {
    ...
    getSingleShared(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            getCachedResponse({ key: `sharedStory:${sharedId}`, cb: () => __awaiter(this, void 0, void 0, function* () {
                    const shared = yield SharedStoryServiceInstance.getSharedStoryById(sharedId);
                    return shared;
                }), reqMtd: ['POST', 'PUT', 'PATCH', 'DELETE'] })
                .then((sharedStory) => {
                if (!sharedStory)
    ...
    unShareUserStory(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!userId || !sharedId)
                return res.sendStatus(400);
            yield autoDeleteOnExpire(userId);
            const result = yield SharedStoryServiceInstance.unShareStory(userId, sharedId);
    ...
    getSharedStoriesByUser(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!userId)
                return res.sendStatus(400);
            yield autoDeleteOnExpire(userId);
            getCachedResponse({ key: `userSharedStories:${userId}`, timeTaken: 1800, cb: () => __awaiter(this, void 0, void 0, function* () {
                    const sharedStory = yield SharedStoryServiceInstance.getUserSharedStories(userId);
                    return sharedStory;
                }), reqMtd: ['POST', 'PUT', 'PATCH', 'DELETE'] })
                .then((sharedStories) => {
