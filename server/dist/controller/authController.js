...
class AuthenticationController extends UserService {
    ...
    registerUser(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            const newUser = yield userServiceInstance.createUser(Object.assign({}, user));
            if (type === 'LINK') {
    ...
    accountConfirmation(req, res) {
        asyncFunc(res, () => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!token)
                return res.sendStatus(400);
            const user = yield userServiceInstance.getUserByVerificationToken(token);
            if (!user) {
                ...
                if (!(verify === null || verify === void 0 ? void 0 : verify.email))
                    return res.sendStatus(400);
                const user = yield userServiceInstance.getUserByEmail(verify === null || verify === void 0 ? void 0 : verify.email);
