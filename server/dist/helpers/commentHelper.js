...
export const createComment = (comment) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield StoryModel.findByIdAndUpdate(comment.storyId, { $push: { commentIds: newComment === null || newComment === void 0 ? void 0 : newComment._id } });
    return newComment;
});
...
export const deleteSingleComment = (commentId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield StoryModel.findByIdAndUpdate(comment.storyId, { $pull: { commentIds: comment === null || comment === void 0 ? void 0 : comment._id } });
...
export const deleteAllUserComments = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all(userComments.map(comment => {
        StoryModel.findByIdAndUpdate(comment.storyId, { $pull: { commentIds: comment._id } });
...
export const createResponse = (response) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield CommentModel.findByIdAndUpdate(response.commentId, { $push: { commentResponse: newResponse === null || newResponse === void 0 ? void 0 : newResponse._id } });
    return newResponse;
});
...
export const deleteSingleResponse = (responseId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield CommentModel.findByIdAndUpdate(response.commentId, { $pull: { commentResponse: response === null || response === void 0 ? void 0 : response._id } });
});
export const deleteAllUserResponses = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all(comments.map((comment) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield Promise.all(userResponse.map(response => {
            CommentModel.findByIdAndUpdate(comment._id, { $pull: { commentResponse: response._id } });
        }));
    })));
...
export const deleteAllUserResponseInComment = (userId, commentId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield Promise.all(userResponse.map(response => {
        CommentModel.findByIdAndUpdate(response.commentId, { $pull: { commentResponse: response._id } });
    }));
