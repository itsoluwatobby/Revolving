...
export function contentFeedAlgorithm(entry, numLikes = 50) {
    const mostLikedPosts = entry === null || entry === void 0 ? void 0 : entry.filter(post => Number(post === null || post === void 0 ? void 0 : post.likes) >= numLikes);
    const otherLikedPosts = entry === null || entry === void 0 ? void 0 : entry.filter(post => Number(post === null || post === void 0 ? void 0 : post.likes) < numLikes);
...
function shufflePosts(content) {
    for (let i = (content === null || content === void 0 ? void 0 : content.length) - 1; i > 0; i--) {
...
function sortByTime(content) {
    content === null || content === void 0 ? void 0 : content.sort((a, b) => Number(b === null || b === void 0 ? void 0 : b.createdAt) - Number(a === null || a === void 0 ? void 0 : a.createdAt));
}
